export const personalInfo = {
  ...
  summary: [
    ...
    'Ranked in the Top 10% globally for both PHP and JavaScript proficiency via TestDome, ensuring high-quality, production-ready code that meets international standards.',
  ],
  skills: {
    stacks: ['VILT Stack (Vue 3, Inertia.js, Laravel, Tailwind)', 'MERN Stack (MongoDB, Express, React, Node.js)'],
    frontend: ['Vue 3', 'React', 'Tailwind CSS', 'Inertia.js', 'Responsive UI/UX'],
    backend: ['PHP (Laravel)', 'Python (Django)', 'Node.js', 'RESTful API Design'],
    ai: ['LLM Integration', 'OpenAI', 'Chatbots', 'Predictive Analysis', 'Automated Reporting', 'Laravel Prism'],
    geospatial: ['Leaflet.js', 'Google Maps API', 'GIS Mapping', 'GeoJSON', 'Survey Builders'],
    mobile: ['Ionic', 'Cordova', 'Hybrid App Development'],
    infrastructure: ['MySQL', 'SQL', 'MongoDB', 'Bash Scripting', 'Git', 'CI/CD'],
    tools: ['GitHub', 'WordPress', 'SEO'],
  },
  stats: [
    { label: 'Years Experience', value: '7+' },
    { label: 'Projects Completed', value: '30+' },
    { label: 'Top 10% PHP', value: 'TestDome' },
    { label: 'Top 10% JS', value: 'TestDome' },
  ],
}
